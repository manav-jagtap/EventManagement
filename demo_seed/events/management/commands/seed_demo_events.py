...
class Command(BaseCommand):
    help = "Create 10 realistic EventHub demo events with local banner images."
    ...
    def handle(self, *args, **options):
        ...
        if organizer1.role != User.Role.ORGANIZER or organizer2.role != User.Role.ORGANIZER:
            raise CommandError("Organizer01 and Organizer02 must both have organizer role.")

        # Copy the demo_banners folder from the package to:
        # PROJECT_ROOT/demo_banners/
        ...
        events = [
            {
                ...
                "description": (
                    "A future-focused technology conference featuring AI, cloud, "
                    "cybersecurity, developer tools and emerging digital trends. "
                    "Designed for students, developers, founders and technology enthusiasts."
                ),
            ...
            },
            {
                ...
                "description": (
                    "A practical coding workshop covering Python fundamentals, Django, "
                    "models, templates, forms and building a small web application. "
            ...
            },
            {
                ...
                "description": (
                    "An energetic evening of live bands, contemporary music and stage "
                    "performances in Mumbai. A social music experience for college students, "
                    "young professionals and live-music fans."
                ),
            ...
            },
            {
                ...
                "description": (
                    "A startup and entrepreneurship networking event bringing together "
                    "students, founders, professionals and mentors for talks, networking "
                    "and idea exchange."
                ),
            ...
            },
            {
                ...
                "description": (
                    "A community football tournament featuring local teams, competitive "
                    "matches and an energetic match-day atmosphere for players and fans."
                ),
            ...
            },
            {
                ...
                "description": (
                    "A colourful celebration of art, cultural performances, exhibitions, "
                    "creative installations and local talent in a festival-style setting."
                ),
            ...
            },
            {
                ...
                "description": (
                    "An evening carnival featuring food stalls, local flavours, live music, "
                    "social spaces and a relaxed festival atmosphere."
                ),
            ...
            },
            {
                ...
                "description": (
                    "A creative-industry meetup for designers, creators and students with "
                    "portfolio discussions, visual showcases, panel conversations and "
            ...
            },
            {
                ...
                "description": (
                    "A city fitness event combining a community marathon experience with "
                    "fitness stalls, wellness activities and an energetic sports atmosphere."
                ),
            ...
            },
            {
                ...
                "description": (
                    "A guided photography-focused heritage walk for students, travellers "
                    "and photography enthusiasts, with opportunities to capture architecture, "
                    "landscapes and historic surroundings."
                ),
        ...
        for item in events:
            ...
            start_at = timezone.make_aware(
                datetime.strptime(item["start_at"], "%Y-%m-%d %H:%M")
            )
            end_at = timezone.make_aware(
                datetime.strptime(item["end_at"], "%Y-%m-%d %H:%M")
            )
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    f"{action}: {event.title} -> {event.organizer.username}"
                )
            )
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Done. Created {created_count}, updated {updated_count} demo events."
            )
        )
